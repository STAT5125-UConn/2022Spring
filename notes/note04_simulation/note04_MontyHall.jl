...
begin
    ...
    function whichDoor(choice; nds=3)
        ...
        return (host=host, prize=prize, switch=switch)
    end
...
# ╔═╡ 597d02a5-218f-40d5-9c3b-2f5def20351d
md"""## Simulation

We use a simulation to find the answer.
"""

# ╔═╡ f892fe78-f6a6-42db-84c5-0b65a17b9d9a
md"""
Your choice = $(@bind choice NumberField(1:1:3))
"""

# ╔═╡ fef08663-3232-4906-b587-35db52582996
md"""
Now the host open a door with goat. 
$(@bind showhost Select(["hide", "show"])) 
"""

# ╔═╡ c9a7af1b-51c1-4f32-a597-9aa76dab7559
begin
	onegame = whichDoor(choice)
	doors_open1 = repeat(door, outer=(1,3))
	doors_open1[loc_hand,(choice-1)*p.+(1+mh:p-mh)] = hand
	doors_open1[loc_goat,(onegame.host-1)*p.+(1+mg:p-mg)] = goat
	showhost == "show" ? doors_open1 : nothing
end

# ╔═╡ b109f6d9-b3f2-42ef-a3f9-e6c0a81bdb40
md"""
Do you want to switch to door number *$(setdiff(1:3, [choice, onegame.host]))*?

Now let's see where the car is. $(@bind showcar Select(["hide", "show"])) 
"""

# ╔═╡ 1df9e00c-2495-4a78-9a82-9b4a18e1ef42
begin
	doors_open2 = copy(doors_open1)
...
# ╔═╡ 8257af5f-3a58-4aaa-8c83-fec99b828667
results

# ╔═╡ 3a47e437-a8e3-4af6-9a91-a9ecb19e3d45
begin
	p_not = mean([any(results[i] .== "🚪👈🚗") for i in 1:n])
md"""
If yo don't switch, the proportion of finding the car is: $(p_not)
"""
end

# ╔═╡ 22b1cc5d-5be9-4868-ba80-0a57da66e733

begin
	p_switch = mean([any(results[i] .== "🚪👌🚗") for i in 1:n])
md"""
If yo switch, the proportion of finding the car is: $(p_switch)
"""
end
